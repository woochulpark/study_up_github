...
<div id="mainContainer">
	...
	<div id="fullpage-nav">
		<ul>
			...
			<li><a onclick="fullpage_api.moveTo(4);"><em></em><span>NOTICE/FAQ</span></a></li><!--191101수정-->
		</ul>
	</div>
		...
		<div class="section section03">
			...
			<div class="main_product_wrap">
				<div class="main_product_slide">
					...
					<div><a><img src="/img/ins_prd02.jpg"/></a></div>
		...
		<div class="section section04">
			...
			<div class="main_notice_wrap">
				...
				<div class="faq bo_box">
					<h2>자주묻는 질문<a class="more_btn">MORE</a></h2>
					<div class="faq_tab">
						<ul>
							<li class="active">
								<a>
					...
					<div class="faq_list faq_list1 active">
						<dl class="active">
							<dt>
								<var><b>Q.</b>보상되지 않는 항목들은 어떤 것들이 있나요?</var>
								<span></span>
							</dt>
							<dd>
								<p>
