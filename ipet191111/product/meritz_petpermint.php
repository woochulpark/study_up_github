			...
			<div class="pet_info">
				...
				<div class="txt">
					<span>현재 보장 정보를 조회하신 반려 동물 이름
						<var class="name"> : 댕댕이 | 나이 : 8세</var>
					</span>
				</div>
			</div>
			<div class="back_btn">
				<a><span>비교조회 페이지로 돌아가기</span></a>
			</div>
		</div>
	</div>
	...
	<div class="prod_intro">
		...
		<div class="inner">
			...
			<div class="sub_tit animate_con">
				...
				반려동물에게 <span class="point2">꼭 맞는 메리츠화재 펫실비보험!</span>
			</div>
		</div>
	</div>
	...
	<div class="meritz_point_wrap">
		...
		<div class="meritz_point02">
			...
			<ul>
				...
				<li>
					<p>반려견 평균수명 - 한국경제,2018년 1월 16일</p>
				</li>
			 </ul>
