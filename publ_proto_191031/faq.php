...
<div class="sub_visual" style="background:url('/img/sub/sub_visual03.jpg')center; background-size:cover">
	<div class="visual_txt">
		<h1 class="white"><img src="/img/logo_white.png"/><span>FAQ</span></h1>
	</div>
</div>
<div id="faqWrap">
	<div class="bo_top">
		<div class="bo_tit">FAQ</div>
	</div>

	<div class="faq_tab">
		<ul>
			<li class="<?php echo $cate=='ipet'||$cate==''?"active":""?>">
				<a href="/faq.php?cate=ipet">
					아이펫
				</a>
			</li>
			<li  class="<?php echo $cate=='petsafe'?"active":""?>">
				<a href="/faq.php?cate=petsafe">
					DB손해보험 <dfn></dfn>-펫세이프
				</a>
			</li>
			<li  class="<?php echo $cate=='petpermint'?"active":""?>">
				<a href="/faq.php?cate=petpermint">
					메리츠 화재 <dfn></dfn>-펫퍼민트
				</a>
			</li>
		</ul>
	...
	<div class="faq_contents">
		...
		<div id="faq_ipet" class="faq_con">
			<dl>
				<dt>
					<div class="q_tit"><b>Q.</b>아이펫은 어떤 서비스인가요?</div>
					<span></span>
				</dt>
				<dd>
					<p>
						아이펫은 국내의 다양한 반려견/반려묘 보험 서비스의 보장 내용을 소개하며 내 반려견/반려묘에 어울리는 가장 적합한 보장 내용을 확인하고 각 보험사의 인터넷
						다이렉트 가입 페이지를 이용하여 바로 보험을 가입할 수 있는 서비스를 제공합니다.
					</p>
				</dd>
			</dl>
			<dl>
		...
		<?php 
		}else if($cate=='petsafe'){
		?>
		<div id="faq_petsafe" class="faq_con">
			<dl>
				<dt>
					<div class="q_tit"><b>Q.</b>보상되지 않는 항목은 어떤 것들이 있나요?</div>
					<span></span>
				</dt>
				<dd>
					<p>
						기존의 질병과 부상, 과잉진료행위로 인한 비용, 임신/출산 관련 비용, 중성화 수술비,
						정기검진 등의 비용, 미용/성형 비용, 무자격자의 치료 행위, 선천적/유전적 질환, 백신
						등 예방접종비, 한방 등 대체 치료, 광견병 및 그로 인한 질병 등이 대표적으로
						보상되지 않는 항목 들입니다. 보다 자세한 사항은 약관을 꼭 확인해주세요.
					</p>
				</dd>
			</dl>
			<dl>
		...
		<?php 
		}else if($cate=='petpermint'){
		?>
		<div id="faq_petpermint" class="faq_con">
			<dl>
				<dt>
					<div class="q_tit"><b>Q.</b>[강아지] 알릴 의무에 슬개골탈구 진단을 표기하니, 부담보가 표시됩니다. 부담보란 무엇인가요?</div>
					<span></span>
				</dt>
				<dd>
					<p>
						슬개골탈구로 진단 받은 경우에는 기타 뒷다리의 질병에 대한 가능성도 높은
						상황이기 때문에, 뒷다리 근골격계에 대한 것은 모두 부담보 적용이 됩니다.
						부담보란, 특정 담보에 대해서는 보상이 되지 않는 조건으로 보험 가입이 가능한 것을
						말합니다. 위와 같은 경우, 뒷다리 근골격계에 대한 질환은 보상이 되지 않는
						조건으로 가입하지만, 근골격계가 아닌 예컨대, 뒷다리 피부병의 경우는 보험
						적용대상이라고 보시면 됩니다.
					</p>
				</dd>
			</dl>
...
<script>
$('.faq_con dl').eq(0).addClass('active');
$('.faq_con dl').eq(0).find('dd').slideDown();

$('.faq_con dl dt').click(function(){
	var faq_item = $(this).parent('dl');
	if(faq_item.hasClass('active')){ // close
